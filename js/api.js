...
chamaPiracicaba = async () => {
    ...
    let resp = await(await fetch(urlSearch+'location:piracicaba&per_page=100&access_token='+accessToken))
    .json()
...
chamaTipoPiracicaba = async (tipo) => {
    let resp = await (await fetch(urlSearch+'location:piracicaba+type:'+tipo+'&per_page=100&access_token='+accessToken))
    .json()
